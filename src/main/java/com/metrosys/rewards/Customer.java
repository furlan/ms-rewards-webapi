...
public class Customer {
    ...
    private Reward[] getRewardsSampleByCustomer(String Id){
        ...
        switch (Id) {
            case "1":
                values = new int[]{ 100, 210, 40, 50, 500 }; // Expected rewards: 1170
                r1 = new Reward("4", values);
                values = new int[]{ 155, 2100, 50, 50, 800, 500, 8734 }; // 23828
                r2 = new Reward("5", values);
                values = new int[]{ 16, 30, 40, 49, 50, 21, 1 }; // 0
                r3 = new Reward("6", values);
                rewards = new Reward[]{r1, r2, r3}; // 24998
                break;
            case "2":
                values = new int[]{ 10, 280, 43, 505, 654 }; // 2428
                r1 = new Reward("4", values);
                values = new int[]{ 1755, 2700, 46, 532, 653 }; // 10680
                r2 = new Reward("5", values);
                values = new int[]{ 176, 543, 2323, 33, 865 }; // 7214
                r3 = new Reward("6", values);
